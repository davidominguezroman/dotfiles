...
static       char dmenufont[60]          = "JetBrains Mono:size=12";

static char dmenunormfgcolor[] = "#D9CFC5";
static char dmenunormbgcolor[] = "#13387c";
static char dmenuselfgcolor[] = "#D9CFC5";
static char dmenuselbgcolor[] = "#1f5ac7";
static char dmenubordercolor[] = "#13387c";
...
static char *colors[SchemeLast][4] = {
	/*                       fg         bg         border    */
	[SchemeNorm]         = { "#D9CFC5", "#13387c", "#13387c" }, /*#492B2D*/
	[SchemeTitleNorm]    = { "#D9CFC5", "#13387c", "#0c244f" },
	[SchemeTitleSel]     = { "#D9CFC5", "#1f5ac7", "#1f5ac7" }, /*#82363A*/
	[SchemeScratchNorm]  = { "#D9CFC5", "#13387c", "#0c244f" },
	[SchemeScratchSel]   = { "#D9CFC5", "#1f5ac7", "#1f5ac7" }, /*#1f5ac7*/
	[SchemeHidNorm]      = { "#D9CFC5", "#13387c", "#000000" },
	[SchemeHidSel]       = { "#D9CFC5", "#1f5ac7", "#000000" },
	[SchemeUrg]          = { "#E0E0E0", "#A23419", "#A23419" }, /*#1f5ac7*/
	[SchemeMarked]       = { "#DDC470", "#724559", "#724559" },
	[SchemeWsNorm]       = { "#D9CFC5", "#13387c", "#000000" },
	[SchemeWsVisible]    = { "#D9CFC5", "#1f5ac7", "#000000" }, /*#13387c*/
	[SchemeWsSel]        = { "#D9CFC5", "#1f5ac7", "#000000" },
	[SchemeWsOcc]        = { "#D9CFC5", "#13387c", "#000000" }, /*#13387c*/
};
...
static const char *file[]  = {NULL, "thunar", NULL};
static const char *code[]  = {NULL, "code", NULL};
static const char *rofi[]  = {NULL, "rofi", "-show", "drun"};
...
static Key keys[] = {
	...
	{ KeyPress,   MODKEY|Alt,                   XK_b,            togglebar,              {0} }, // toggles the display of the bar(s) on the current monitor

	{ KeyPress,   MODKEY,                       XK_b,            spawn,                  {.v = browser }}, // spawn browser
	{ KeyPress,   MODKEY,                       XK_e,            spawn,                  {.v = file}}, // spawn file explorer
	{ KeyPress,   MODKEY,                       XK_c,            spawn,                  {.v = code}}, // spawn vsCode
	{ KeyPress,   MODKEY|Ctrl,                  XK_Return,       spawn,                  {.v = rofi}}, // spawn rofi
...
//	STACKKEYS(AltGr|Shift,                                       stackswap)                            // swap the currently focused client with the nth client in the stack
	...
	SCRATCHKEYS(MODKEY|Ctrl,                    XK_e,            spcmd_e)
...
static Button buttons[] = {
	...
	{ ClkLtSymbol,               0,                       Button4,        setlayout,        {-1} }, // toggles between current and previous layout
